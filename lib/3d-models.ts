...
export const CHARACTER_MODELS_3D: Model3DOption[] = [
  ...
  {
    id: 'artificie-mulher',
    name: 'Artífice (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Atificie/Artificie Mulher.glb',
    description: 'Mestra da alquimia, engenharia arcana e invenções mágicas',
    icon: '⚙️',
  },
  {
    id: 'barbaro',
  ...
  },
  {
    ...
    name: 'Bárbara (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Barbaro/Barbara.glb',
    description: 'Guerreira feroz com traje de pele e lâmina pesada',
    icon: '🪓',
  },
  {
    id: 'bardo',
  ...
  },
  {
    ...
    name: 'Barda (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Bardo/Barda.glb',
    description: 'Artista carismática, perita em canções arcanas e encantos',
    icon: '🪕',
  },
  {
    id: 'bruxo',
  ...
  },
  {
    ...
    name: 'Bruxa (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Bruxo/Bruxa.glb',
    description: 'Conjuradora pactuada com patrono místico',
    icon: '🔮',
  },
  {
    id: 'clerigo',
  ...
  },
  {
    ...
    name: 'Clériga (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Clerigo/Cleriga.glb',
    description: 'Devota sagrada protegida por armadura e fé divina',
    icon: '✝️',
  },
  {
    id: 'druida',
    ...
    description: 'Guardiã da natureza com cajado místico e veste clássica',
    icon: '🌿',
  },
  {
    id: 'druida-homem',
    name: 'Druida (Homem)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Duida/Druida Homem.glb',
    description: 'Guardião da natureza com cajado místico e veste clássica',
    icon: '🌿',
  },
  {
    id: 'feiticeiro',
    name: 'Feiticeiro (Homem)',
    category: 'character',
  ...
  {
    id: 'feiticeira',
    name: 'Feiticeira (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Feiticeiro/Feiticeira.glb',
    description: 'Conjuradora nata com magia fluindo no sangue',
    icon: '⚡',
  },
  {
    id: 'guerreiro',
    name: 'Guerreiro (Homem)',
    category: 'character',
  ...
  {
    id: 'guerreira',
    name: 'Guerreira (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Guerreiro/Guerreira.glb',
    description: 'Mestra do combate marcial e armaduras reluzentes',
    icon: '⚔️',
  },
  {
    id: 'ladino',
  ...
  },
  {
    ...
    name: 'Ladina (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Ladino/Ladina.glb',
    description: 'Especialista furtiva, mestra do golpe traiçoeiro',
    icon: '🗡️',
  },
  {
    id: 'mago',
  ...
  },
  {
    ...
    name: 'Maga (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Mago/Maga.glb',
    description: 'Mestra das artes arcanas em pose de conjuração',
    icon: '🪄',
  },
  {
    id: 'monge',
  ...
  },
  {
    ...
    name: 'Monja (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Monge/Monja Mulher.glb',
    description: 'Mestra das artes marciais e canalização de Ki',
    icon: '🥋',
  },
  {
    id: 'paladino',
  ...
  {
    id: 'paladina',
    name: 'Paladina (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Paladino/Paladina.glb',
    description: 'Cavaleira sagrada regida por juramentos e virtudes',
    icon: '🛡️',
  },
  {
    id: 'patrulheiro-homem',
    name: 'Patrulheiro / Ranger (Homem)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Patrulheiro/Patrulheiro Homem.glb',
    description: 'Caçador ágil e mestre do rastreio na selva',
    icon: '🏹',
  },
  {
    id: 'patrulheira',
    name: 'Patrulheira / Ranger (Mulher)',
    category: 'character',
    modelUrl: '/assets/3d/characters/Patrulheiro/Patrulheiro.glb',
    description: 'Caçadora ágil e mestra do rastreio na selva',
    icon: '🏹',
  },
];
