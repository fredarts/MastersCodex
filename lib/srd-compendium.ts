...
const RAW_EQUIPMENT: SRDItem[] = [
  ...
  { name: 'Pique (Lança Longa)', category: 'Arma', weight: 18, cost: '5 po', description: 'Dano: 1d10 perfurante. Propriedades: Pesada, alcance, duas mãos.' },
  ...
  // Equipamentos de Aventura (Adventuring Gear)
  { name: 'Ácido (frasco)', category: 'Equipamento', weight: 1, cost: '25 po', description: 'Como ação, você pode arremessar contra criatura/objeto a até 6m. Dano: 2d6 ácido.' },
  { name: 'Algemas', category: 'Equipamento', weight: 6, cost: '2 po', description: 'Possuem restrições para escapar (CD 20 Destreza/Força).' },
  { name: 'Algibeira (Bolsa de cinto)', category: 'Equipamento', weight: 1, cost: '5 pc', description: 'Pode guardar até 20 moedas ou pequenos itens.' },
  { name: 'Ampulheta', category: 'Equipamento', weight: 1, cost: '25 po', description: 'Mede o tempo com precisão (areia).' },
  { name: 'Apito de Sinalização', category: 'Equipamento', weight: 0, cost: '5 pc', description: 'Gera um som agudo audível a longas distâncias.' },
  ...
  { name: 'Balde', category: 'Equipamento', weight: 2, cost: '5 pc', description: 'Capacidade para cerca de 12 litros de líquido.' },
  { name: 'Barril', category: 'Equipamento', weight: 70, cost: '2 po', description: 'Pode conter até 150 litros de líquido ou equivalente.' },
  { name: 'Baú', category: 'Equipamento', weight: 25, cost: '5 po', description: 'Armazena até 150 kg de carga.' },
  { name: 'Caneca de Metal', category: 'Equipamento', weight: 1, cost: '2 pc', description: 'Caneca robusta de metal para bebidas.' },
  { name: 'Cobertor de Inverno', category: 'Equipamento', weight: 3, cost: '5 pr', description: 'Para descanso em clima frio.' },
  { name: 'Componentes de Magia (Algibeira)', category: 'Equipamento', weight: 2, cost: '25 po', description: 'Contém componentes materiais básicos para magias.' },
  ...
  { name: 'Fechadura', category: 'Equipamento', weight: 1, cost: '10 po', description: 'Fechadura de ferro com chave correspondente (CD 15 para abrir).' },
  ...
  { name: 'Foco Arcano (Cajado)', category: 'Equipamento', weight: 4, cost: '5 po', description: 'Foco de conjuração para feiticeiros, bruxos ou magos.' },
  { name: 'Foco Arcano (Cristal)', category: 'Equipamento', weight: 1, cost: '10 po', description: 'Foco de conjuração cristalino.' },
  { name: 'Foco Arcano (Orbe)', category: 'Equipamento', weight: 3, cost: '20 po', description: 'Foco de conjuração esférico.' },
  { name: 'Foco Arcano (Varinha)', category: 'Equipamento', weight: 1, cost: '10 po', description: 'Varinha canalizadora de energia mágica.' },
  { name: 'Foco Druídico (Ramo de Visco)', category: 'Equipamento', weight: 0, cost: '1 po', description: 'Ramo seco de visco sagrado.' },
  { name: 'Foco Druídico (Totem)', category: 'Equipamento', weight: 0, cost: '1 po', description: 'Pequeno totem feito de dentes, garras ou penas sagradas.' },
  { name: 'Frasco ou Ampola', category: 'Equipamento', weight: 0, cost: '1 po', description: 'Recipiente pequeno de vidro ou metal.' },
  { name: 'Gancho de Escalar', category: 'Equipamento', weight: 4, cost: '2 po', description: 'Gancho de metal de três pontas para ancorar cordas.' },
  { name: 'Garrafa de Vidro', category: 'Equipamento', weight: 2, cost: '2 po', description: 'Capacidade 750 ml.' },
  { name: 'Giz (1 peça)', category: 'Equipamento', weight: 0, cost: '1 pc', description: 'Giz comum para marcação.' },
  ...
  { name: 'Livro', category: 'Equipamento', weight: 5, cost: '25 po', description: 'Um livro comum de anotações, desenhos ou contos.' },
  ...
  { name: 'Martelo', category: 'Equipamento', weight: 2, cost: '1 po', description: 'Martelo comum de artífice ou marceneiro.' },
  ...
  { name: 'Pá', category: 'Equipamento', weight: 5, cost: '2 po', description: 'Pá de metal para escavações gerais.' },
  { name: 'Papel (folha)', category: 'Equipamento', weight: 0, cost: '2 pr', description: 'Folha de papel comum de alta qualidade.' },
  ...
  { name: 'Pederneira e Aço (Isqueiro)', category: 'Equipamento', weight: 1, cost: '5 pr', description: 'Caixa para iniciar fogo rapidamente.' },
  { name: 'Pergaminho (folha)', category: 'Equipamento', weight: 0, cost: '1 pr', description: 'Folha para escrita de magia ou registros.' },
  { name: 'Perfume (frasco)', category: 'Equipamento', weight: 0, cost: '5 po', description: 'Frasco pequeno com fragrância agradável.' },
  { name: 'Píton', category: 'Equipamento', weight: 0.25, cost: '5 pc', description: 'Estaca de metal usada em alpinismo.' },
  { name: 'Porta-Mapas ou Pergaminhos', category: 'Equipamento', weight: 1, cost: '1 po', description: 'Tubo protetor de couro ou latão.' },
  ...
  { name: 'Roldana e Polia', category: 'Equipamento', weight: 5, cost: '1 po', description: 'Permite erguer até 4 vezes o peso normal de carga.' },
  { name: 'Sabão (barra)', category: 'Equipamento', weight: 0, cost: '2 pc', description: 'Para limpeza básica pessoal.' },
  { name: 'Saco', category: 'Equipamento', weight: 0.5, cost: '1 pc', description: 'Saco de lona simples para carregar até 15 kg.' },
  { name: 'Saco de Dormir', category: 'Equipamento', weight: 7, cost: '1 po', description: 'Conforto básico para repouso no deserto ou masmorra.' },
  { name: 'Símbolo Sagrado (Amuleto)', category: 'Equipamento', weight: 1, cost: '5 po', description: 'Símbolo sagrado canalizador de magia divina.' },
  { name: 'Símbolo Sagrado (Emblema)', category: 'Equipamento', weight: 0, cost: '5 po', description: 'Emblema gravado em escudo ou vestimenta.' },
  { name: 'Sinete (anel)', category: 'Equipamento', weight: 0, cost: '5 po', description: 'Anel usado para selar documentos com cera quente.' },
  { name: 'Sino', category: 'Equipamento', weight: 0, cost: '1 po', description: 'Pequeno sino de metal de som agudo.' },
  { name: 'Tenda de Duas Pessoas', category: 'Equipamento', weight: 20, cost: '2 po', description: 'Abrigo de lona simples de montar.' },
  { name: 'Tinta (frasco de 30ml)', category: 'Equipamento', weight: 0, cost: '10 po', description: 'Frasco pequeno de tinta escura para escrita.' },
  ...
  { name: 'Vela', category: 'Equipamento', weight: 0, cost: '1 pc', description: 'Queima por 1 hora fornecendo luz em raio de 1.5m.' },
  ...
  { name: 'Poção de Voo', category: 'Poção', weight: 0.5, cost: '250 po', description: 'Concede deslocamento de voo de 18m por 1 hora.' },
  { name: 'Poção de Invisibilidade', category: 'Poção', weight: 0.5, cost: '300 po', description: 'Torna o usuário invisível por 1 hora, ou até atacar ou conjurar uma magia.' },
  { name: 'Poção de Força do Gigante (Colina)', category: 'Poção', weight: 0.5, cost: '200 po', description: 'A Força muda para 21 por 1 hora.' },
  { name: 'Poção de Escalar', category: 'Poção', weight: 0.5, cost: '50 po', description: 'Concede deslocamento de escalada igual ao caminhada por 1 hora.' },
  ...
  { name: 'Ferramentas de Alquimista', category: 'Ferramenta', weight: 8, cost: '50 po', description: 'Contém provetas, balões de destilação e frascos químicos.' },
  { name: 'Ferramentas de Oleiro', category: 'Ferramenta', weight: 3, cost: '10 po', description: 'Material para moldar e assar argila.' },
  { name: 'Ferramentas de Sapateiro', category: 'Ferramenta', weight: 5, cost: '5 po', description: 'Material para consertar e fazer calçados.' },
  { name: 'Ferramentas de Pedreiro', category: 'Ferramenta', weight: 8, cost: '10 po', description: 'Material para talhar pedra e argamassa.' },
  { name: 'Ferramentas de Alfaiate', category: 'Ferramenta', weight: 5, cost: '1 po', description: 'Material para tecer, tricotar e costurar tecidos.' },
  { name: 'Ferramentas de Entalhador', category: 'Ferramenta', weight: 5, cost: '1 po', description: 'Cinzeis e facas para esculpir madeira.' },
  { name: 'Ferramentas de Joalheiro', category: 'Ferramenta', weight: 2, cost: '25 po', description: 'Lupas, pinças e limas para metais e gemas preciosas.' },
  { name: 'Ferramentas de Pintor', category: 'Ferramenta', weight: 5, cost: '10 po', description: 'Cavalete, tintas, pincéis e telas de pintura.' },
  { name: 'Ferramentas de Coureiro', category: 'Ferramenta', weight: 5, cost: '5 po', description: 'Ferramentas para cortar, furar e marcar couro.' },
  { name: 'Ferramentas de Cartógrafo', category: 'Ferramenta', weight: 6, cost: '15 po', description: 'Instrumentos para desenhar mapas e pergaminhos.' },
  { name: 'Kit de Jogo (Cartas)', category: 'Ferramenta', weight: 0, cost: '5 pr', description: 'Baralho de cartas comum para jogos de azar.' },
  { name: 'Kit de Jogo (Dados)', category: 'Ferramenta', weight: 0, cost: '1 pr', description: 'Conjunto de dados esculpidos em osso ou madeira.' },
  { name: 'Kit de Veneno', category: 'Ferramenta', weight: 2, cost: '50 po', description: 'Contém ingredientes químicos e vidraria para preparar venenos.' },
  { name: 'Instrumento Musical (Alaúde)', category: 'Ferramenta', weight: 2, cost: '35 po', description: 'Instrumento musical de cordas dedilhadas.' },
  { name: 'Instrumento Musical (Flauta)', category: 'Ferramenta', weight: 1, cost: '2 po', description: 'Instrumento musical de sopro leve de madeira.' },
  { name: 'Instrumento Musical (Lira)', category: 'Ferramenta', weight: 2, cost: '30 po', description: 'Instrumento musical de cordas clássico e sofisticado.' },

  // Tesouro
  { name: 'Gema Bruta', category: 'Tesouro', weight: 0.1, cost: '10 po', description: 'Uma pedra preciosa bruta de valor modesto.' },
  { name: 'Joia Fina', category: 'Tesouro', weight: 0.2, cost: '100 po', description: 'Uma joia lapidada com esmero por artesãos.' },
  { name: 'Anel de Ouro', category: 'Tesouro', weight: 0.1, cost: '25 po', description: 'Anel simples de ouro puro.' },
  { name: 'Estatueta de Prata', category: 'Tesouro', weight: 1, cost: '50 po', description: 'Uma pequena peça de arte moldada em prata.' }
];

export const SRD_EQUIPMENT: SRDItem[] = RAW_EQUIPMENT.map(item => ({
  ...item,
  weight: parseFloat((item.weight * 0.5).toFixed(2)) // Converter libras para kg (1 lb = 0.5 kg)
}));
